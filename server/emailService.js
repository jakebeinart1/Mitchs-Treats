...
<head>
  ...
  <style>
    ...
    .header { background: linear-gradient(135deg, #0047AB 0%, #4A8FE7 100%); padding: 40px 30px; text-align: center; }
    ...
    .section-title { color: #0047AB; font-size: 18px; font-weight: 700; margin: 0 0 16px 0; border-bottom: 2px solid #FFD700; padding-bottom: 8px; }
    ...
    .items-table td { padding: 12px; border-bottom: 1px solid #e5e5e7; }
    .item-name { font-weight: 600; color: #1d1d1f; }
    .item-details { color: #666; font-size: 14px; margin-top: 4px; }
    .item-price { text-align: right; font-weight: 600; color: #0047AB; }
    .total-row { background-color: #fff9f0; font-weight: 700; }
    .total-row td { border-top: 2px solid #FFD700; padding: 16px 12px; font-size: 18px; color: #0047AB; }
    .special-instructions { background-color: #fff9f0; border-left: 4px solid #FFD700; padding: 16px; border-radius: 4px; margin-top: 12px; }
    .special-instructions-title { font-weight: 600; color: #0047AB; margin: 0 0 8px 0; }
      ...
      <div class="section">
        ...
        <div class="info-grid">
          ...
          <div class="info-row">
            ...
            <div class="info-value"><a href="mailto:${orderData.customer.email}" style="color: #0047AB; text-decoration: none;">${orderData.customer.email || 'Not provided'}</a></div>
          </div>
          <div class="info-row">
            <div class="info-label">Phone:</div>
            <div class="info-value"><a href="tel:${orderData.customer.phone}" style="color: #0047AB; text-decoration: none;">${orderData.customer.phone || 'Not provided'}</a></div>
          </div>
          <div class="info-row">
              ...
              return `
                <tr>
                  <td>
                    ...
                    ${item.flavor ? `<div class="item-details">Flavor: ${item.flavor}</div>` : ''}
                  </td>
